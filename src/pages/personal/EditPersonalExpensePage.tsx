      ...
      <div className="flex-1 px-4 mt-4 pb-8 flex flex-col gap-4">
        ...
        <fieldset className="fieldset w-full">
          ...
          <div className="join w-full">
            <button
              type="button"
              className={`join-item btn btn-sm btn-pagination-compact flex-1 ${paidBy === "self" ? "btn-active" : ""}`}
            ...
            <button
              type="button"
              className={`join-item btn btn-sm btn-pagination-compact flex-1 ${paidBy === "contact" ? "btn-active" : ""}`}
