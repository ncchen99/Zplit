  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm text-center">
        <h1 className="text-4xl font-bold tracking-tight text-primary">Zplit</h1>
        <p className="mt-2 text-base-content/60">{t('auth.login.subtitle')}</p>

        <div className="mt-10 flex flex-col gap-3">
          <button className="btn btn-primary btn-block" onClick={handleGoogleLogin}>
