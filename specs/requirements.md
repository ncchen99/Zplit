...
**Zplit** 旨在為你與最親近的朋友打造一個**隨時待命、長久相伴**的分帳空間。我們相信分帳不該是活動結束後的瑣事，而是一份共同生活的默契：

- **延續情誼，無需重來**：成員與朋友圈資料**永久保留**，讓每一次相聚的帳務都能無縫接軌，省去重複建立群組的時間。
- **全方位生活管家**：無論是大型群組活動還是日常一對一紀錄，都能以最直覺的方式同步，讓生活步調始終保持一致。
- **資料永恆同步**：跨裝置即時更新，確保每一筆珍貴的紀錄都安全、精準地留存在雲端，實現永續且優雅的帳務管理。
